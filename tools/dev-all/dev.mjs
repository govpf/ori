...
const APPS = [
  ...
  {
    short: 'AGENT',
    name: 'Espace agent (Angular)',
    port: 5173,
    url: 'http://localhost:5173',
    color: 'red',
    command: 'pnpm --filter @govpf/ori-example-agent dev',
  },
  {
    short: 'LAND',
    ...
    color: 'white',
    command: 'pnpm --filter @govpf/ori-example-landing dev',
  },
  {
    short: 'KC',
    name: 'Mires Keycloak (HTML)',
    port: 4174,
    url: 'http://localhost:4174',
    color: 'gray',
    command: 'pnpm --filter @govpf/ori-example-keycloak dev',
  },
];
