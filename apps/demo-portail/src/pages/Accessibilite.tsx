  ...
  return (
    ...
    >
      <LegalSection title="État de conformité">
        ...
        <p>
          Le RGAA est le référentiel français qui définit les règles permettant aux sites
          web et aux applications mobiles d'être utilisables par les personnes en situation
          de handicap. Il est aligné sur le standard international{' '}
      ...
      <LegalSection title="Résultat de l'audit">
        <LegalDefinitionList
          items={[
            ...
            { term: 'Échantillon testé', description: '15 pages représentatives du parcours usager' },
            {
              term: 'Taux de conformité global',
              description: <><strong>87 %</strong> des critères applicables respectés</>,
            },
          ]}
        />
      </LegalSection>
      ...
      <LegalSection title="Contenus non accessibles">
        <p>
          Malgré nos efforts, certains contenus présentent encore des défauts
          d'accessibilité. Nous travaillons activement à leur correction.
        </p>
        <h3>Non-conformités connues</h3>
        <ul className="legal-list">
          <li>
            Certaines anciennes pièces jointes au format PDF ne respectent pas intégralement
            les règles de balisage. Une refonte progressive est en cours.
          </li>
          <li>
          ...
          <li>
            Une partie des vidéos mises en ligne avant 2025 ne sont pas encore sous-titrées ;
            un programme de sous-titrage rétroactif est planifié sur l'année 2026.
          </li>
        </ul>
        <h3>Dérogations</h3>
        <p>
          Aucune dérogation pour <em>charge disproportionnée</em> n'a été déclarée. Les
          contenus tiers (cartes interactives, modules embarqués) qui ne relèveraient pas
          de la responsabilité directe de l'éditeur sont signalés au cas par cas.
        </p>
      </LegalSection>
      ...
      <Alert severity="info" title="Voies de recours">
        ...
        ou à une fonctionnalité, vous pouvez nous contacter pour être orienté vers une
        alternative ou obtenir le contenu sous une autre forme.
      </Alert>
      ...
      <LegalSection title="Nous contacter">
        ...
        <LegalDefinitionList
          items={[
            ...
            { term: 'Téléphone', description: '+689 40 47 20 00 (du lundi au vendredi, 7h30 - 14h30)' },
        ...
        <p>
          ...
          maximum, en proposant le cas échéant un mode alternatif d'accès au service
          demandé.
        </p>
      </LegalSection>
      ...
      <LegalSection title="Recours">
        <p>
          Cette procédure de réclamation est à utiliser dans le cas où vous n'avez pas
          obtenu de réponse satisfaisante après nous avoir contactés. Vous pouvez :
        </p>
        <ul className="legal-list">
          <li>
          ...
          <li>
            Saisir la <strong>Défenseure des droits</strong> via le formulaire en ligne ou
            par courrier
          </li>
        </ul>
      </LegalSection>
