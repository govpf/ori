    ...
    >
      ...
      <LegalSection title="Finalités du traitement">
        ...
        <ul className="legal-list">
          <li>
            <strong>Identification et authentification</strong> de l'usager via le système Keycloak
            du Gouvernement
          </li>
          <li>
          ...
          <li>
            <strong>Notification</strong> de l'avancement des démarches et des évènements importants
            liés au compte
          </li>
          <li>
          ...
          items={[
            {
              term: 'Compte usager',
              description:
                'Tant que le compte est actif. Suppression possible à tout moment depuis la page Sécurité.',
            },
            {
              term: 'Démarches',
              description:
                'Conservées pendant la durée nécessaire à leur traitement, puis archivées selon les obligations légales (généralement 5 à 10 ans selon le type de démarche).',
            },
            {
              term: 'Pièces justificatives',
              description:
                "Conservées pendant la durée d'instruction de la démarche, puis archivées ou supprimées selon les règles applicables au type de pièce.",
            },
            {
            ...
            },
            {
              ...
              description:
                "30 jours avant suppression définitive (délai de rétractation). Conservation de l'historique des démarches selon les obligations légales applicables.",
            },
          ]}
        />
      </LegalSection>
      ...
      <LegalSection title="Vos droits">
        ...
        <ul className="legal-list">
          ...
          <li>
            <Tag variant="info">Limitation</Tag> Limiter le traitement de vos données dans certaines
            situations
          </li>
          <li>
          ...
          <li>
            <Tag variant="info">Portabilité</Tag> Récupérer vos données dans un format structuré et
            lisible
          </li>
          <li>
      ...
      <LegalSection title="Cookies et traceurs">
        ...
        <ul className="legal-list">
          ...
          <li>
            <strong>Cookies de préférences</strong> : conservent vos choix (thème, langue) sur votre
            navigateur, durée de vie 12 mois
          </li>
          <li>
