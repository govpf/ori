...
current: "introduction-installation-react"
...
- [Patterns React](?path=/docs/introduction-patterns-react--docs) - création d'un
  composant qui consomme le DS
- [Décisions / Décisions de design](?path=/docs/décisions-décisions-de-design--docs)
