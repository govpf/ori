// Copie les artefacts CSS générés par @govpf/ori-css + le crest officiel
// PF à côté de la landing page pour qu'elle puisse les charger en relatif.
// Lancé via les hooks `predev` et `prebuild`.
